"""
MAINTENANCE: Re-attempt TMDB matching for specific rows from a CSV review file.

Purpose:
  Selectively retry TMDB matching for catalog_items that were previously
  matched incorrectly or marked as not_found. Input is a CSV with barcode
  and optional override title columns.

Tables/fields mutated:
  catalog_items: tmdb_id, tmdb_title, tmdb_match_status, tmdb_last_refreshed_at,
...
Safe mode: --dry-run (prints what would change without writing)
